...
func InsertMerchant(data entities.MerchantInsert, deviceId string) (status bool) {
	...
	q := "INSERT INTO merchant(user_id, qris_data, qris_email, qris_password, qris_mnid, qris_name, created_by) value (?,?,?,?,?,?,?)"
...
func UpdateMerchant(data map[string]interface{}) {
